...
var menueditorcontrol = {
  ...
  updateMenu: function()
  {
    window.serumMenuEditor.update();
    alert(window.serumMenuEditor.getString());
      ...
      var ctl = h('div', {}, 
        ...
        h('div', { 'className': 'card border-primary mb-3' },
          ...
          h('div', { 'className':'card-footer' },
            ...
            h('button', { 'type':'button', 'id': 'btnAdd', 'className':'btn btn-success ml-2', 'onclick': this.updateMenu },
